...
export const navigation: NavigationLink[] = [
    ...
    {
        label: 'Categoria', url: '/shop/catalog', menu: {
            type: 'megamenu',
            size: 'nl',
            columns: [
                {
    ...
    {
        label: 'Tienda', url: '/shop/catalog/power-tools', menu: {
            type: 'menu',
            items: [
                {
                    label: 'Shop Grid', url: '/shop/catalog/power-tools', items: [
                        {
                            label: '3 Columns Sidebar', url: '/shop/catalog/power-tools', items: [
    ...
    },
    {
        label: 'Account', url: '/account', menu: {
            ...
            items: [
                ...
                { label: 'Panel', url: '/account/dashboard' },
                { label: 'Editar perfil', url: '/account/profile' },
                { label: 'Historial de pedidos', url: '/account/orders' },
                // { label: 'Detalles del pedido', url: '/account/orders/5' },
                { label: 'Address Book', url: '/account/addresses' },
                // { label: 'Editar dirección', url: '/account/addresses/5' },
    ...
    },
    {
        label: 'Pages', url: '/site', menu: {
            ...
            items: [
                ...
                { label: 'Contactanos Alt', url: '/site/contact-us-alt' },
