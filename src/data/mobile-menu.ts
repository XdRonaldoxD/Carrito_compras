...
[
    ...
    {type: 'link', label: 'Shop', url: '/shop/catalog/power-tools', children: [
        {type: 'link', label: 'Shop Grid', url: '/shop/catalog/power-tools', children: [
            {type: 'link', label: '3 Columns Sidebar',  url: '/shop/catalog/power-tools' , children:[
                {type: 'link', label: '3 Columns Sidebar subhija',  url: '/shop/catalog/power-tools'},
            ]},
    ...
    {type: 'link', label: 'Account', url: '/account', children: [
        ...
        {type: 'link', label: 'Panel',       url: '/account/dashboard'},
        {type: 'link', label: 'Editar perfil',    url: '/account/profile'},
        {type: 'link', label: 'Historial de pedidos',   url: '/account/orders'},
        // {type: 'link', label: 'Detalles del pedido',   url: '/account/orders/5'},
        {type: 'link', label: 'Address Book',    url: '/account/addresses'},
        // {type: 'link', label: 'Editar dirección',    url: '/account/addresses/5'},
    ...
    {type: 'link', label: 'Pages', url: '/site', children: [
        ...
        {type: 'link', label: 'Contactanos',           url: '/site/contact-us'},
        {type: 'link', label: 'Contactanos Al',       url: '/site/contact-us-alt'},
