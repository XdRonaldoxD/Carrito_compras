...
export class DepartmentsComponent implements OnInit, OnDestroy, AfterViewInit, AfterViewChecked {
    ...
    constructor(
        ...
        private zone: NgZone,
        private api_servicio:ProductosService
    ) { }
    ...
    ngOnInit(): void {
        ...
        console.log('departament menu',this.items);
        this.api_servicio.MegaMenuProductos().pipe(takeUntil(this.destroy$)).subscribe((resp)=>{
