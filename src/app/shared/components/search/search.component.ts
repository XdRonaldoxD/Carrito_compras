...
import { debounceTime, map, switchMap, takeUntil, throttleTime, finalize } from 'rxjs/operators';
...
export class SearchComponent implements OnChanges, OnInit, OnDestroy {
    ...
    constructor(
        ...
        private producto_servicio: ProductosService,
    ...
    ngOnChanges(changes: SimpleChanges): void {
        if (changes.location && this.location === 'header') {
            ...
            this.producto_servicio.TodasCategoriaPadre().pipe(takeUntil(this.destroy$)).subscribe(resp=>{
